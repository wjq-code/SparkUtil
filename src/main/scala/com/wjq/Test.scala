...
//import com.springml.spark.sftp.{DatasetRelation, DeleteTempFileShutdownHook, constants}
//import com.springml.spark.sftp.util.Utils.ImplicitDataFrameWriter
//import com.wjq.MyFTPClient
...
//class Test extends RelationProvider with SchemaRelationProvider with CreatableRelationProvider {
//  @transient val logger = Logger.getLogger(classOf[Test])
//
//  *
...
//    }
//
//    val sftpClient = getMyFTPClient(username, password, pemFileLocation, pemPassphrase, host, port,
...
//  }
//
//  private def upload(source: String, target: String, sftpClient: MyFTPClient) {
//    logger.info("Copying " + source + " to " + target)
//    sftpClient.copyToFTP(source, target)
//  }
//
//  private def getMyFTPClient(
...
//                              port: Option[String],
//                              cryptoKey: String,
//                              cryptoAlgorithm: String): FTPClient = {
//
...
//  }
//
//  private def copy(sftpClient: FTPClient, source: String,
